...
public:
	...
	struct Nerf {
		...
		struct Training {
			...
			bool optimize_extra_dims = true;
			bool optimize_focal_length = false;
            bool optimize_exposure = true;
