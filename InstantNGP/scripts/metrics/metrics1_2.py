...
dir_path = "/home/hcorreia/PycharmProjects/instant-ngp/data/videos_exp1/utilizados_exp/2"
...
excel_path = "/home/hcorreia/PycharmProjects/instant-ngp/data/Results_1_2.xlsx"
...
# textfile = open('/home/hcorreia/PycharmProjects/instant-ngp/data/Result_1.txt', 'w')
# for i in range(len(list_listT)):
#     for y in range(len(list_listT[i])):
#         textfile.write(str(list_listT[i][y]) + ',')
#     textfile.write("\n")
# textfile.close()
