...
save = "/home/hcorreia/PycharmProjects/instant-ngp/data/Results1_align_Human_S_Face"
groud_truth_path = "/home/hcorreia/PycharmProjects/instant-ngp/data/ground_exp1_HUMAN"
...
plt.title("Box Plot Experiment 1 - Human Heads")
plt.ylabel('Mean Error Distance')
plt.xlabel('Number of imagens')
plt.savefig("Exp1 Human Heads S Face")
plt.show()
plt.close()
plt.clf()
plt.cla()
