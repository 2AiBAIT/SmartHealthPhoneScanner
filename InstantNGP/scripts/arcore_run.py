...
def parse_args():
	...
	parser.add_argument("--save_mesh", default="/home/hcorreia/PycharmProjects/instant-ngp/data/test.obj", help="Output a marching-cubes based mesh from the NeRF or SDF model. Supports OBJ and PLY format.")
