...
dir_path = "/home/hcorreia/PycharmProjects/instant-ngp/data/videos_exp1_Human"
save = "/home/hcorreia/PycharmProjects/instant-ngp/data"
groud_truth_path = "/home/hcorreia/PycharmProjects/instant-ngp/data/ground_exp2"
excel_path = "/home/hcorreia/PycharmProjects/instant-ngp/data/Results_2.xlsx"
...
for path in os.listdir(dir_path):
    if os.path.isfile(os.path.join(dir_path, path)):
        ...
        for i in range(len(list_n_frames)):
            ...
            os.system('python /home/hcorreia/PycharmProjects/instant-ngp/scripts/colmap2nerf.py --video_in ' + video_path + ' --video_fps ' + str(list_n_frames[i]))

            for k in range(len(list_n_epochs)):
                col = 2
                file = x[0] + '_' + str(list_n_frames[i]) + '_' + str(list_n_epochs[k]) + 'Test.ply'
                file_export = '/home/hcorreia/PycharmProjects/instant-ngp/data/Results1_HUMAN/' + x[0] + '_' + str(
                    list_n_frames[i]) + '_' + str(list_n_epochs[k]) + 'Test.ply'
                save_file = os.path.join(save, file)
                print(save_file)

                os.system('python /home/hcorreia/PycharmProjects/instant-ngp/scripts/run.py --save_mesh ' + file_export + ' --epochs ' + str(list_n_epochs[k]))
