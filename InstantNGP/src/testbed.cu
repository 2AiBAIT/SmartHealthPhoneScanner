...
void Testbed::imgui() {
        ...
        if (ImGui::CollapsingHeader("Rendering", ImGuiTreeNodeFlags_DefaultOpen)) {
                ...
                m_render_aabb.max[0] = 1.063; //1.079
                m_render_aabb.max[1] = 1.063;
                m_render_aabb.max[2] = 1.063;
                m_render_aabb.min[0] = -0.063; //-0.079
                m_render_aabb.min[1] = -0.063;
                m_render_aabb.min[2] = -0.063;
...
void Testbed::saveData(int a)
{
    std::ofstream file;
    file.open("/home/hcorreia/PycharmProjects/instant-ngp/data/example.txt");
    file << a << " ";
    file.close();
}
...
//    list->AddImageQuad((ImTextureID)(size_t)1, ImVec2{0.f, 0.f}, ImVec2{(float)display_w, 0.f}, ImVec2{(float)display_w, (float)display_h}, ImVec2{0.f, (float)display_h}, ImVec2(0, 0), ImVec2(1, 0), ImVec2(1, 1), ImVec2(0, 1));
