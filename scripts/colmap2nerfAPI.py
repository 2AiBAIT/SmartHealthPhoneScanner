...
def parse_args():
	...
	parser.add_argument("--video_in", default="/home/hcorreia/PycharmProjects/instant-ngp/data/video_14/model4_1.mp4",
						help="run ffmpeg first to convert a provided video file into a set of images. uses the video_fps parameter also")
	parser.add_argument("--video_fps", default=3)  # /home/hcorreia/PycharmProjects/instant-ngp/data/video10.mp4
...
if __name__ == "__main__":
	...
	os.remove('/home/hcorreia/PycharmProjects/instant-ngp/data/n_images.txt')
	file_object = open('/home/hcorreia/PycharmProjects/instant-ngp/data/n_images.txt', 'a')
