from fastapi import FastAPI, status, File, UploadFile, responses
import uvicorn
import cv2
...
from scripts.scenes import scenes_nerf, scenes_image, scenes_sdf, scenes_volume, setup_colored_sdf
...
def parse_args():
	...
	parser.add_argument("--scene", "--training_data", default="/home/hcorreia/PycharmProjects/instant-ngp/data", help="The scene to load. Can be the scene's name or a full path to the training data.")
	...
	parser.add_argument("--save_mesh", default="/home/hcorreia/PycharmProjects/instant-ngp/data/face1.obj", help="Output a marching-cubes based mesh from the NeRF or SDF model. Supports OBJ and PLY format.")
	...
	parser.add_argument("--train", default=True, action="store_true", help="If the GUI is enabled, controls whether training starts immediately.")
	parser.add_argument("--n_steps", type=int, default=-1, help="Number of steps to train for before quitting.")
	parser.add_argument("--second_window", default=True, action="store_true", help="Open a second window containing a copy of the main output.")
...
def upload_singleFile(file: UploadFile = File(...)):
    ...
    return responses.FileResponse("/home/hcorreia/PycharmProjects/instant-ngp/data/test.obj", media_type="model/3mf",
...
def upload_files(files: List[UploadFile] = File(...)):
	...
	run_nerf()
	return responses.FileResponse("/home/hcorreia/PycharmProjects/instant-ngp/data/face1.obj", media_type="model/3mf",
                           status_code=status.HTTP_201_CREATED, filename="face1.obj")
